...
public enum ModuleType {
	...
	SolarModule("Solar Panel", "E + 180", 4, 2, true, add(Resource.Fe, 25, add(Resource.Si, 25))),
	...
	RocketModule("Rockets", "E - 20", 3, 3, true, add(Resource.H2O, 100, add(Resource.Fe, 400, add(Resource.Si, 150)))),
	MagnetModule("Magnet", "E - 120", 3, 3, true, add(Resource.Fe, 300, add(Resource.Si, 150))),
	CryogenicModule("Cryogenic", "", 3, 3, true, add(Resource.H2, 80, add(Resource.H2O, 300, add(Resource.Food, 150, add(Resource.Fe, 600, add(Resource.Si, 400)))))),
